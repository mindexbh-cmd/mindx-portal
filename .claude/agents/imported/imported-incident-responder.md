---
name: imported-incident-responder
...
<!--
Imported from VoltAgent/awesome-claude-code-subagents (MIT License,
Copyright (c) 2025 VoltAgent — https://github.com/VoltAgent/awesome-claude-code-subagents).
Renamed with the imported- prefix to namespace it apart from the
project-custom agents. Frontmatter name field updated to match.
-->
